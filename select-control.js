...
  // **Função que atualiza o texto do trigger do select customizado**
  const updateCustomSelectTrigger = () => {
...
  });
  
  // **NOVO LISTENER:** Adicionado para garantir a sincronização em ambas as direções.
  $originalSelect.on('change', function() {
    updateCustomSelectTrigger();
    validateSelect();
  });

  // Chama a função de atualização inicial para garantir que o texto do trigger esteja correto no carregamento da página
  updateCustomSelectTrigger();

  // Listener para o botão de próximo, se necessário
